...
export default function Page() {
  return (
    <div>
      ...
      >
        {renderMarkdown(`
<big>**2026年10月**</big> から着手のご依頼を受付中です！
※短納期でも対応可能な場合がございますのでご気軽にお問い合わせください！

## ご挨拶
イラストレーターのかなたなかと申します。
美少女キャラクターの魅力を最大限に引き出す絵作りを意識しております。

![ポートフォリオ](/images/portfolio.png)

VTuber様のキャラクターデザインも多数担当しております。

![ポートフォリオ](/images/portfolio2.png)
...
【サイズ】
  縦・横の長さ（または比率）など
【キャラクターの詳細】
  人数・描写範囲（バストアップ、膝上、全身など）、頭身、表情、服装、ポーズ、シチュエーションなど
